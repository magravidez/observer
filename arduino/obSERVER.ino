...
const float TEMP_THRESHOLD = 31.0;
...
// 15-second polling interval to match the frontend refresh rate
...
void setup() {
  ...
  Serial.println("obSERVER ready. Sending readings every 15 seconds.\n");
}
...
void loop() {
  ...
  if (temperature > TEMP_THRESHOLD) {
    // Activate alarm: 1 kHz tone on buzzer, red LED on
